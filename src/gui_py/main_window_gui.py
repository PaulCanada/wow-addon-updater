...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tviewAddons.setAutoExpandDelay(-1)
        self.tviewAddons.setSortingEnabled(True)
        ...
        self.frameUpdates = QtWidgets.QFrame(self.frameOutput)
        self.frameUpdates.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameUpdates.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameUpdates.setObjectName("frameUpdates")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.frameUpdates)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.btnDownloadUpdates = QtWidgets.QPushButton(self.frameUpdates)
        self.btnDownloadUpdates.setMinimumSize(QtCore.QSize(0, 40))
        self.btnDownloadUpdates.setObjectName("btnDownloadUpdates")
        self.gridLayout_5.addWidget(self.btnDownloadUpdates, 0, 1, 1, 1)
        self.btnCheckForUpdates = QtWidgets.QPushButton(self.frameUpdates)
        self.btnCheckForUpdates.setMinimumSize(QtCore.QSize(0, 40))
        self.btnCheckForUpdates.setObjectName("btnCheckForUpdates")
        self.gridLayout_5.addWidget(self.btnCheckForUpdates, 0, 0, 1, 1)
        self.gridLayout_2.addWidget(self.frameUpdates, 2, 0, 1, 1)
        self.gridLayout.addWidget(self.splitter, 1, 0, 1, 2)
        self.frameUpdate = QtWidgets.QFrame(self.centralwidget)
        self.frameUpdate.setEnabled(True)
        self.frameUpdate.setMaximumSize(QtCore.QSize(16777215, 75))
        self.frameUpdate.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameUpdate.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameUpdate.setObjectName("frameUpdate")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.frameUpdate)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.lblLoadingMovie = QtWidgets.QLabel(self.frameUpdate)
        self.lblLoadingMovie.setMaximumSize(QtCore.QSize(16777215, 75))
        self.lblLoadingMovie.setAlignment(QtCore.Qt.AlignCenter)
        self.lblLoadingMovie.setObjectName("lblLoadingMovie")
        self.verticalLayout.addWidget(self.lblLoadingMovie)
        self.lblCurrentUpdate = QtWidgets.QLabel(self.frameUpdate)
        self.lblCurrentUpdate.setMaximumSize(QtCore.QSize(16777215, 20))
        self.lblCurrentUpdate.setAlignment(QtCore.Qt.AlignCenter)
        self.lblCurrentUpdate.setObjectName("lblCurrentUpdate")
        self.verticalLayout.addWidget(self.lblCurrentUpdate)
        self.gridLayout_4.addLayout(self.verticalLayout, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.frameUpdate, 3, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnDownloadUpdates.setText(_translate("MainWindow", "Download Updates"))
        self.btnCheckForUpdates.setText(_translate("MainWindow", "Check For Updates"))
        self.lblLoadingMovie.setText(_translate("MainWindow", "QMovie Update GIF"))
        self.lblCurrentUpdate.setText(_translate("MainWindow", "V / M"))
